...
<div>
    ...
    <div class="container-xl page__content page__content-mobile py-5">
        <div class="container-xl">
            <div class="page__title fs-1 mx-5" id="teste">Leonardo kkkkkkkk</div>
        </div>
        <div class="container-xl d-flex">
            ...
            <div class="d-flex flex-column w-100 content-mobile-container" style="margin-left: 3em;margin-right: 1em;">
                ...
                <div class="d-flex flex-column py-1">
                    ...
                    <span class="margin-bottom">{{ $store.state.userData.state?.nome }} - {{ $store.state.userData.city }}</span>
                </div>

                <div class="d-flex flex-column py-1">
                    <span style="font-weight: 600;" class="py-2">Especialidade principal</span>
                    <span class="margin-bottom">{{ $store.state.userData.mainExpertise?.nome }}</span>
                </div>
                ...
                <!-- confirm button -->
                <router-link to="/thank-you"><Button style="background-color: #FBDE40" class="w-100 fs-5" button-title="cadastrar profissional" id="register_professional"></Button></router-link>
            ...
            <div class="image-container w-100 align-self-center page__image-container">
                <img src="../assets/desktop-pagina-3.png" class="img-fluid page__image">
            </div>
        </div>
    </div>
</div>
